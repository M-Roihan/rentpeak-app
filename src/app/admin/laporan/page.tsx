      ...
      <div className="flex min-h-screen bg-slate-50 font-sans">
        ...
        <div className="flex-1 p-6 md:p-10 h-screen overflow-y-auto">
          ...
          <div className="flex justify-between items-end mb-4">
            <h3 className="text-xl font-bold text-slate-800" style={{ fontFamily: '"Sora", sans-serif' }}>Semua Booking</h3>
            <Button onClick={handleExportCSV} variant="ghost" className="border-slate-300">
